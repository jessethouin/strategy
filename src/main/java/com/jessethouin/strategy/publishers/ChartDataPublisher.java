...
public class ChartDataPublisher {
    ...
    public ChartDataPublisher(Config config, BarSeries barSeries, Strategy strategy, Flux<MarketData> alpacaMarketDataFlux, Sinks.Many<ChartData> alpacaChartDataSink) {
        this.config = config;
    ...
    public void subscribe() {
        alpacaMarketDataFlux.subscribe(marketData -> {
            ...
            switch (config.getStrategy()) {
                ...
                case SMA, DEFAULT -> chartData = SMAStrategy.getSMAChartData(barSeries.getEndIndex(), strategy);
            }
